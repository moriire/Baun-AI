...
<template>
 <div class="row justify-content-center align-items-center py-4" style="height:90vh;">
  <div v-show="disable" class="col-lg-10 col-md-10 col-sm-10 col-xs-12 mx-3 my-2 h-100">
